...
const SideNav: FC = () => {
  ...
  return (
    <>
      {
        modalOpen && activeModal === 'program' && <SetupProgramModal modalOpen={modalOpen} setModalOpen={setModalOpen} />
      }
      {
        modalOpen && activeModal === 'cohort' && <SetupCohortModal modalOpen={modalOpen} setModalOpen={setModalOpen} />
      }
