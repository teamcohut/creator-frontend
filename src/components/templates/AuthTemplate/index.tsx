  ...
  return (
    <>
      <div className='container-fluid justify-content-center form-template px-4 py-6 p-md-5'>
        <div className='h-100 row d-flex justify-content-center justify-lg-content-between'>
          ...
          <div className='form-container col-lg-6 d-flex align-items-start justify-content-center'> 
