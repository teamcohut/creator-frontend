...
const OverviewCard: React.FC<IOverviewCard> = ({icon, title, subtitle, iconBgColor, iconBorderColor, children}) => {
  return (
    <>
      <div className="overview-card d-flex align-items-start gap-3 p-3">
        <span className={`overview-icon p-3`} style={{ backgroundColor:  iconBgColor, border: `1px solid ${iconBorderColor}`}}>
          {icon}
        </span>
