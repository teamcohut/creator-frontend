      ...
      <>
        ...
        >
          <SuccessCard
            ...
            title="Mail Resent"
            description={`A verification link has been resent to ${email}. Please check your inbox and click the link to continue.`}
          >
            <span className="dark-500 manrope-500 fs-small">
              Didn&apos;t get an email?
            </span>
            <Button
              action={() => setSent(false)}
