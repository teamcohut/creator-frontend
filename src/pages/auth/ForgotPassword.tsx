        ...
        <AuthTemplate title='The simplest solution is often the best solution.' author='William of Ockham'>
          <SuccessCard
            ...
            <div className="w-auto d-flex flex-column align-items-center gap-5">
              <span className='manrope-500 dark-700 fs-body'>A verification link has been sent to <span className="primary-700">{email}</span>. Please check your inbox and click the link to continue.</span>
